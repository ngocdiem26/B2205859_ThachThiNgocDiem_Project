...
const user = ref(null)
const showUserMenu = ref(false) // Thêm trạng thái hiển thị menu
...
const toggleMobileMenu = () => {
    // Giả định hàm này được sử dụng để đóng/mở sidebar trên mobile
    // Nếu props.modelValue đại diện cho trạng thái sidebar, có thể dùng emit
...
// NEW: Hàm xử lý Đăng xuất
const handleLogout = () => {
    // Xóa tất cả các mục liên quan đến phiên đăng nhập
